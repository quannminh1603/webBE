...
//         const { orderItems, paymentMethod, itemsPrice, shippingPrice, totalPrice, hoTenKH, diaChi, sdt ,user, isPaid, paidAt,email } = newOrder
//         try {
//             const promises = orderItems.map(async (order) => {
//                 const productData = await Product.findOneAndUpdate(
//                     {
//                     _id: order.product,
//                     soLuongConLai: {$gte: order.amount}
//                     },
//                     {$inc: {
//                         soLuongConLai: -order.amount,
//                         selled: +order.amount
//                     }},
//                     {new: true}
//                 )
